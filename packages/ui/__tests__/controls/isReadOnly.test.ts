...
describe("isReadOnly", () => {
  const readOnlyTypes = ["boolean", "currency", "date", "time", "datetime", "options", "number_of_instances", "text", "file", "number"] as const;
  ...
  describe("unsupported control types always return false", () => {
    const unsupportedTypes = ["typography", "image", "document", "generative_chat", "entity", "interview_container", "switch_container", "repeating_container", "data_container", "certainty_container", "markdown"];
